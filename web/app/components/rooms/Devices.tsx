        ...
        <>
            {devices.length > 0 ? (
                    ...
                    <table className="w-full">
                        <thead>
                            <tr>
                                ...
                                <th className="font-medium text-sm uppercase bg-[#f9fafd] border-b border-gray-200 py-2 px-4 text-left">Ostatnia synchronizacja</th>
                            </tr>
                        </thead>
                        <tbody>
                            {devices.map((device) => (
                                <tr key={device.id}>
                                    ...
                                    <td className="border-b border-gray-200 py-2 px-4 text-sm">
                                        <Link href={`/devices/${device.id}`} className="link_tag">
                                            {device.name}
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5 rotate-125">
                ...
                <div className="flex flex-col items-center justify-center pt-10">
                    <img src="/empty-state-devices1.png" alt="Empty State Illustration" className="w-[140px]" />
