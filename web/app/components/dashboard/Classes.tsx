...
export default function Classes({ timetables }: { timetables: Timetable[] }) {
  return (
    <div className="shadow-xs rounded-2xl p-4 bg-white">
      <h2 className="text-lg font-medium mb-6">Zajęcia w tym tygodniu</h2>
        ...
        {timetables.map((timetable) => (
          <div key={timetable.id} className="flex items-center pb-4">
            ...
            <div className="grow">
              ...
              <p>
                Sala {timetable.room.number}: {timetable.name}
              </p>
            </div>
