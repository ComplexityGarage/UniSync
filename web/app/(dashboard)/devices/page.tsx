          ...
          <table className="w-full">
            <thead>
              <tr>
                ...
                <th className="font-medium text-sm uppercase bg-[#f9fafd] border-b border-gray-200 py-2 px-4 text-right">
                  Akcje
                </th>
              </tr>
            </thead>
            <tbody>
              {devices.map((device) => {
                const lastSyncAt = device.syncLogs[0]
                  ? device.syncLogs[0].createdAt
                  : null
                      ...
                      <div className="flex gap-4 justify-end">
                        ...
                        <Form action={deleteDevice}>
                          ...
                          <button className="btn-outline-sm">
                            ...
                            >
                              <path
                                d="M12.7833 7.99995L12.495 15.4999M8.505 15.4999L8.21667 7.99995M16.5233 5.32495C16.8083 5.36828 17.0917 5.41411 17.375 5.46328M16.5233 5.32578L15.6333 16.8941C15.597 17.3651 15.3842 17.8051 15.0375 18.126C14.6908 18.4469 14.2358 18.6251 13.7633 18.6249H7.23667C6.76425 18.6251 6.30919 18.4469 5.96248 18.126C5.61578 17.8051 5.40299 17.3651 5.36667 16.8941L4.47667 5.32495M16.5233 5.32495C15.5616 5.17954 14.5948 5.06919 13.625 4.99411M3.625 5.46245C3.90833 5.41328 4.19167 5.36745 4.47667 5.32495M4.47667 5.32495C5.43844 5.17955 6.4052 5.06919 7.375 4.99411M13.625 4.99411V4.23078C13.625 3.24745 12.8667 2.42745 11.8833 2.39661C10.9613 2.36714 10.0387 2.36714 9.11667 2.39661C8.13333 2.42745 7.375 3.24828 7.375 4.23078V4.99411M13.625 4.99411C11.5448 4.83334 9.45523 4.83334 7.375 4.99411"
                                stroke="#344054"
                                strokeWidth="1.5"
                                strokeLinecap="round"
                                strokeLinejoin="round"
